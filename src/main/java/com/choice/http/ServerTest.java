...
import com.choice.utils.ServerPortHelper;
...
public class ServerTest {
	public static void main(String[] args) {
		//声明变量
                ...
                try {
                	int port=Integer.parseInt(ServerPortHelper.getPort());
    ...
    public static void openDefaultBrowser(){
        try {
            ...
            if(os.toLowerCase().startsWith("win")){
                String urlString = String.format("http://%s:%s/welcome.html", ServerPortHelper.getIp(), ServerPortHelper.getPort());
